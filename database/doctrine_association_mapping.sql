...
--
-- Host: doctrine_association_mapping_mysql    Database: doctrine_association_mapping
-- ------------------------------------------------------
...
CREATE TABLE `cart` (
  `id` int NOT NULL AUTO_INCREMENT,
  `number` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `phone_number` (
  `id` int NOT NULL AUTO_INCREMENT,
  `number` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-23 12:40:16
